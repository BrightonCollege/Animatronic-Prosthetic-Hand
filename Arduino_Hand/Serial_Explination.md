...
# Everyone Else
The Arduino code needs to be notified when there is data about to be sent. All the data you will send will be in this format:

- `255` Send this number to initiate the system
- `0-4` This selects the finger, referance the Data_Dictionary file in the planning directory.
- `0 - 180` This is the position you want the finger to be in. 0 is relaxed, 180 is clenched. Please note sending  the values `0` and `180` can be harmful to servos.